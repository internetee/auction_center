...
class FooterTest < ViewComponent::TestCase
  ...
  def test_render_component
    I18n.with_locale(:en) do
      ...
      assert_selector '.c-footer__row__col.s-footer-col a[href="https://www.internet.ee/domain-disputes/domain-disputes-committee"]'
      ...
      assert_selector '.c-footer__row__col.s-footer-col a[href="https://www.internet.ee/registrar-portal/accredited-registrars"]'
      assert_selector '.c-footer__row__col.s-footer-col a[href="https://www.internet.ee/registrar-portal/terms-and-conditions-for-becoming-a-registrar"]'
      assert_selector '.c-footer__row__col.s-footer-col a[href="https://www.internet.ee/registrar-portal/become-a-ee-elite-partner"]'
